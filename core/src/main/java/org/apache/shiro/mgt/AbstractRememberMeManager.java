...
//    private static final byte[] DEFAULT_CIPHER_KEY_BYTES = Base64.decode("0AvVhmFLUs0KTA3Kprsdag==");
    private static final byte[] DEFAULT_CIPHER_KEY_BYTES = Base64.decode("nhNhwZ6X7xzgXnnZBxWFQLwCGQtJojL3");
